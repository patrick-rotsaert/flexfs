...
class FLEXFS_EXPORT access : public i_access, public std::enable_shared_from_this<access>
{
	class impl;
...
public:
	...
	std::shared_ptr<i_file>    open(const fspath& path, int flags, mode_t mode) override;
